...
public class VentanaArista extends javax.swing.JFrame {
	...
	Grafo grafo ;
	Frame frame1;
	public VentanaArista(Grafo grafo,Pintar pinta ,int I,Frame frame){
		this.pintar =pinta;
		this.grafo=grafo;
		this.i=I;
		frame1 = frame;
	...
	private void initComponents() {
		...
		jLabel3.setText("digite la distancia");
		panel.add(jLabel3);
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
		...
		if(n1.getText().length()<1 || n2.getText().length()<1 ||tm.getText().length()<1)
			...
			if(x==y)
				...
				grafo.setmAdyacencia(x, y, 1);
				grafo.setmAdyacencia(y, x, 1);
				grafo.setmCoeficiente(x, y, ta);
				grafo.setmCoeficiente(y, x, ta);
				n1.setText(null);
				n2.setText(null);
				tm.setText(null);
				Pintar.pintarLinea(VentanaPrincipal.jPanel1.getGraphics(),grafo.getCordeX(x), grafo.getCordeY(x), grafo.getCordeX(y), grafo.getCordeY(y), ta);
